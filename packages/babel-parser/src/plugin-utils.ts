...
// NOLA VENDOR EDIT: nola mixin (see VENDOR.md)
import nola from "./plugins/nola/index.ts";
...
// NOLA VENDOR EDIT: nola sits after typescript (composes on top of it).
...
export const mixinPluginNames = Object.keys(mixinPlugins) as readonly (
  ...
  | "typescript"
  | "v8intrinsic"
  // NOLA VENDOR EDIT: nola plugin name (see VENDOR.md)
  | "nola"
  | "placeholders"
)[];
