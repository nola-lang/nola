...
export const tt = {
  ...
  // NOLA VENDOR EDIT: nola plugin token. Appended last so every bounded
  // range helper above excludes it (see VENDOR.md).
  nolaDotDot: createToken("..", { beforeExpr, startsExpr }),
} as const;
