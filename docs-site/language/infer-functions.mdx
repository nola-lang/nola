...
- **Top-level function declarations only.** `infer` on a method, an arrow function or a function expression is reserved for a later version ([`NOLA1004`](/docs/reference/error-codes/#nola1004)); a declaration nested in another function is [`NOLA2003`](/docs/reference/error-codes/#nola2003).
