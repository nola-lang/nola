...
Available in an infer-function marker — or its [body-instruction spelling](/docs/language/infer-functions/#the-body-instruction), and in the module body's first-statement literal (`FunctionPromptScope`):
